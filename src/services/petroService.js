const BASE_URL = 'https://secure.ghostroute.icu/api/v1.0/petro'
 ...
 */
export async function initializePetroSearch(token, latitude, longitude) {
 ...
 */
export async function startPetroSearch(token, searchToken, latitude, longitude) {
